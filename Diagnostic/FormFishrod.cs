...
namespace gta_rp
{
  public class FormFishrod : Form
  {
    private IContainer components;
    private Label label1;

    public FormFishrod() => this.InitializeComponent();

    private void FormClick_FishrodDown(object sender, MouseEventArgs e)
    {
      this.Capture = false;
    ...
    private void FormFishrod_FormClosing(object sender, FormClosingEventArgs e)
    {
      e.Cancel = true;
      this.Hide();
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.label1.MouseDown += new MouseEventHandler(this.FormClick_FishrodDown);
      ...
      this.Name = nameof (FormFishrod);
      this.Opacity = 0.7;
      this.Tag = (object) "fishrod";
      this.TopMost = true;
      this.FormClosing += new FormClosingEventHandler(this.FormFishrod_FormClosing);
      this.MouseDown += new MouseEventHandler(this.FormClick_FishrodDown);
